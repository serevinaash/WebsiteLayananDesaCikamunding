...
@section('title', 'Dashboard | Desa Cikamunding')
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-6">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>{{ $jumlah_feedback }}</h3>
                    <p>Kritik dan Saran</p>
                </div>
                <div class="icon">
                    <i class="fa fa-users"></i>
                </div>
                <a href="{{ route('admin.feedback.index') }}" class="small-box-footer">Detail <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="jumbotron">
                            ...
                            <p class="lead">Terwujudnya Desa Cikamunding yang aman, sehat, cerdas, berbudaya, berakhlaq mulia dan berdaya saing menuju pelayanan yang cepat dan tepat</p>
                            <hr class="my-4">
